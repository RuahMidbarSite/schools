...
export interface GuidesStoreColumns {
colState:ColumnState[],

}
// this is to get the keys of the interface
const defaultObject:GuidesStoreColumns = {
colState:[],
}
 
   const updateStorage = async (data:GuidesStoreColumns):Promise<void> => {
  ...
  const getFromStorage = async ():Promise<GuidesStoreColumns> => {
