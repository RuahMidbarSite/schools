...
app.post("/SendMessage", MemoryWithNoStoring.single("file"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (requestBody.PatternID && !req.file) {
            ...
            if (found_file) {
                ...
                if (media) {
                    ...
                    let media_promise = client.sendMessage(phoneNumber, media)
                        .then(response => {
        ...
        if (uploadedFile) {
            ...
            let fileBuffer = Buffer.from(uploadedFile.buffer);
        ...
        if (requestBody.Message_1) {
            ...
            let message_promise = client.sendMessage(phoneNumber, textMessageBody)
                .then(response => {
